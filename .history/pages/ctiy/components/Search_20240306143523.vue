<template>
	<view class="input">
		<view class="search">
			...
			<input class="search-input" type="text" placeholder="城市/拼音" confirm-type="search"
				@input="handleInput"></input>
			<view class="search-contnet" v-show="inputVal">
				<view class="search-item" v-for="item in list" :key="item.id" @click="handleCityClick(item.name)">
					{{ item.name }}
				</view>
